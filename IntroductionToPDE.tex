...
Here we run trhough the fundamentals of the theory of distributions omitting a few details.
...
\begin{exercise}\label{ex67df0243}
	Show that $\scr D(\Omega)$ is dense in $( C^0_0(\Omega),\|\cdot\|_{L^\infty})$.
\end{exercise}
