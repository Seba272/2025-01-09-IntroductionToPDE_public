...
\begin{theorem}[Kirchhoff's formula]\label{thm67ce9378}
	...
	Vice-versa, let $g\in C^2(\R^3)$ and $h\in C^1(\R^2)$, and define
...
\begin{align*}
	...
	&= \frac{2}{3\omega_3 t^2} \int_{B_t(x,t)} \frac{ \left(g(y) + th(y) + \Diff g(y)\cdot (y-x) \right) }{ (t^2 - |y-x|^2)^{1/2} } \did y \\
	&= \frac12 \fint_{B_2(x,t)} \frac{g + th + \Diff g\cdot (y-x) }{ ( t^2 - |y-x|^2 )^{1/2} } \did S(y) .
\end{align*}
...
\subsection{\TODO}
\begin{itemize}
\item	Formula for all $n$ (see also Folland)
\item	Formula for non-homogeneous wave equation
\item	
\end{itemize}
