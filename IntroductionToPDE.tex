...
For $u\in L^1(\R^n)$ and $x\in\R^n$, define the \emph{Fourier transform}
...
\begin{exercise}
	...
	\item
	If $u\in\scr S'$ and $f\in\scr S$, then $\scr F(u*f) = \hat u \hat f$.
	\end{enumerate}
\end{exercise}
...
\begin{remark}
	...
	There are two sorts of ``equilibrium points'' of this behaviour: $\scr S$ and $L^2(\R^n)$.
\end{remark}
